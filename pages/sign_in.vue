							...
							<div class="registration">
								...
								<form>
									...
									<div class="form-group mt-5">
										...
										<input class="form-control h_50" type="email" placeholder="Entrer votre adresse mail" value="">																								
									</div>
									...
									<button class="main-btn btn-hover w-100 mt-4" type="button" onclick="window.location.href='index.html'">Se connecter <i class="fas fa-sign-in-alt ms-2"></i></button>
								</form>
								<div class="divider">
									<span>or</span>
								</div>
								...
								<div class="new-sign-link">
									Nouveau sur event-CERIL?<a class="signup-link" href="sign_up.html">S'inscrire</a>
								</div>
							</div>							
						</div>
					</div>
