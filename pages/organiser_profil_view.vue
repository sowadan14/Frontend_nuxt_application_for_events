<template>
		...
		<div class="modal-dialog modal-dialog-scrollable">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="FFModalLabel">Suivi et abonnés</h5>
							...
							<div class="tab-content mt-4">
								...
								<div class="tab-pane fade" id="followers" role="tabpanel" aria-labelledby="pills-followers-tab">							
									<div id="followers-empty-state" class="d-flex align-items-center justify-content-center flex-column min-height-430">
										...
										<p class="font-16 mt-4 text-light3">Pas encore d'abonnés</p>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="modal fade" id="aboutModal" tabindex="-1" aria-labelledby="aboutModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="aboutModalLabel">Modifier les détails</h5>
					<button type="button" class="close-model-btn" data-bs-dismiss="modal" aria-label="Close"><i class="uil uil-multiply"></i></button>
				</div>
				<div class="modal-body">
						...
						<div class="row">
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
									...
									<input class="form-control h_40" type="text" placeholder="" value="Basile">																								
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
									<label class="form-label">Nom*</label>
									<input class="form-control h_40" type="text" placeholder="" value="SOWADAN">																								
								</div>
							</div>
							...
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
									...
									<input class="form-control h_40" type="text" placeholder="" value="ba@gmail.com">																								
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
