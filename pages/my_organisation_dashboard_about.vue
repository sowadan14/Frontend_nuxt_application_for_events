<template>
		...
		<div class="modal-dialog modal-medium-2 modal-dialog-scrollable modal-dialog-centered modal-sm-height modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="orgSettingsLabel">Parametre de confidentialité</h5>
						...
						<div class="mt-4">	
							<div class="setting-step main-card p-4">
								<div class="d-flex align-items-center justify-content-between">
									<h3 class="setting-title">Autoriser Event-CERIL à accéder à mon organisation</h3>
									<label class="btn-switch m-0 ml-2">
										<input type="checkbox">
										<span class="checkbox-slider"></span>
									</label>
								</div>
								<p class="mt-1">Si vous activez cette option, Eventbookings pourra gérer votre (vos) organisation(s)</p>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="orgPrivacySettings" tabindex="-1" aria-labelledby="orgPrivacySettingsLabel" aria-hidden="false">
		<div class="modal-dialog modal-medium-2 modal-dialog-scrollable modal-dialog-centered modal-sm-height modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="orgPrivacySettingsLabel">Paramètre de confidentialités</h5>
					<button type="button" class="close-model-btn" data-bs-dismiss="modal" aria-label="Close"><i class="uil uil-multiply"></i></button>
				</div>
				<div class="modal-body p-bg">
					<div class="model-content main-form pt-2 p-4">
						<div class="main-card p-4 mt-4">	
							<div class="setting-step border_bottom">
								<div class="d-flex align-items-center justify-content-between">
									<h3 class="setting-title">Verrouiller le profil de l'organisation</h3>
									<label class="btn-switch m-0 ml-2">
										<input type="checkbox">
										<span class="checkbox-slider"></span>
									</label>
								</div>
								<p class="mt-1 mb-4">Le profil de verrouillage masque toutes sortes d'informations utilisateur, d'activités et d'interactions du profil public</p>
							</div>
							<div class="setting-step border_bottom pt-4">
								<div class="d-flex align-items-center justify-content-between">
									<h3 class="setting-title">Masquer l'adresse sur le profil de mon organisation</h3>
									<label class="btn-switch m-0 ml-2">
										<input type="checkbox" checked>
										<span class="checkbox-slider"></span>
									</label>
								</div>
								<p class="mt-1 mb-4">Masquer l'adresse de votre organisation du profil public de votre organisation</p>
							</div>
							<div class="setting-step border_bottom pt-4">
								<div class="d-flex align-items-center justify-content-between">
									<h3 class="setting-title">Autoriser les gens à contacter mon organisation</h3>
									<label class="btn-switch m-0 ml-2">
										<input type="checkbox" checked>
										<span class="checkbox-slider"></span>
									</label>
								</div>
								<p class="mt-1 mb-4">Les gens pourront vous envoyer des e-mails via Barren qui visite le profil de votre organisation</p>
							</div>
							<div class="setting-step border_bottom pt-4">
								<div class="d-flex align-items-center justify-content-between">
									<h3 class="setting-title">Autoriser les gens à suivre mon organisation</h3>
									<label class="btn-switch m-0 ml-2">
										<input type="checkbox" checked>
										<span class="checkbox-slider"></span>
									</label>
								</div>
								<p class="mt-1 mb-4">Les gens pourront vous suivre</p>
							</div>
							<div class="setting-step border_bottom pt-4">
								<div class="d-flex align-items-center justify-content-between">
									<h3 class="setting-title">Masquer les avis sur le profil de mon organisation</h3>
									<label class="btn-switch m-0 ml-2">
										<input type="checkbox">
										<span class="checkbox-slider"></span>
									</label>
								</div>
								<p class="mt-1 mb-4">Personne ne pourra voir les avis et les notes de votre organisation. Masquer les avis ne permet pas aux autres de donner également un avis ou une note à votre organisation.</p>
							</div>
							<div class="setting-step border_bottom pt-4">
								<div class="d-flex align-items-center justify-content-between">
									<h3 class="setting-title">Masquer les interactions d'avis du public</h3>
									<label class="btn-switch m-0 ml-2">
										<input type="checkbox">
										<span class="checkbox-slider"></span>
									</label>
								</div>
								<p class="mt-1 mb-0">L'évaluation des avis sera disponible dans le profil public de votre organisation, mais nous n'afficherons aucune activité dans aucun flux public.</p>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="modal fade" id="org-profile-update-pop" tabindex="-1" aria-labelledby="orgProfileUpdatepopLabel" aria-hidden="false">
		<div class="modal-dialog modal-medium-2 modal-dialog-scrollable modal-dialog-centered modal-sm-height modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="orgProfileUpdatepopLabel">Détails de l'organisation</h5>
					<button type="button" class="close-model-btn" data-bs-dismiss="modal" aria-label="Close"><i class="uil uil-multiply"></i></button>
				</div>
				<div class="modal-body">
					<div class="model-content main-form">
						<div class="row">
							...
							<div class="col-lg-12 col-md-12">
								<div class="form-group mt-4">
									<label class="form-label">Lien de Profile*</label>
									<div class="loc-group position-relative">
										<input class="form-control h_40" type="text" placeholder="" value="https://www.event-cerile.com/b/organiser/Basile-sowadan">
							...
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
									...
									<input class="form-control h_40" type="text" placeholder="" value="basile14sowadan@gmail.com">																								
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
							...
							<div class="col-lg-12 col-md-12">
								<h4 class="address-title">Adresses</h4>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
							...
							<div class="col-lg-6 col-md-12">
								<div class="form-group main-form mt-4">
									...
									<select class="selectpicker" data-size="5" title="Rien de sélectionné" data-live-search="true">
										<option value="Algeria">Algeria</option>
										<option value="Argentina">Argentina</option>
										<option value="Australia">Togo</option>
							...
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
									<label class="form-label">Ville/Banlieue*</label>
									<input class="form-control h_40" type="text" placeholder="" value="">																								
								</div>
							</div>
				...
				<div class="modal-footer">
					<button type="button" class="co-main-btn min-width btn-hover h_40" data-bs-toggle="modal" data-bs-dismiss="modal">Annuler</button>
					<button type="button" class="main-btn min-width btn-hover h_40">Mettre à jour</button>
				</div>
			</div>
		</div>
	</div>
				...
				<ul>
					...
					<li class="menu--item">
						<a href="my_organisation_dashboard_events.html" class="menu--link active" title="Events" data-bs-toggle="tooltip" data-bs-placement="right">
							...
							<span class="menu--label">Evènements</span>
						</a>
					</li>
					<li class="menu--item">
					...
					<li class="menu--item">
						<a href="my_organisation_dashboard_contact_lists.html" class="menu--link" title="Contact List" data-bs-toggle="tooltip" data-bs-placement="right">
							...
							<span class="menu--label">Liste des contacts</span>
						</a>
					</li>
					<li class="menu--item">
					...
					<li class="menu--item">
						<a href="my_organisation_dashboard_subscription.html" class="menu--link" title="Subscription" data-bs-toggle="tooltip" data-bs-placement="right">
							...
							<span class="menu--label">Abonnements</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="my_organisation_dashboard_conversion_setup.html" class="menu--link" title="Conversion Setup" data-bs-toggle="tooltip" data-bs-placement="right">
							...
							<span class="menu--label">Configuration de la conversion</span>
						</a>
					</li>
					<li class="menu--item">
					...
					<li class="menu--item">
						<a href="my_organisation_dashboard_my_team.html" class="menu--link team-lock" title="My Team" data-bs-toggle="tooltip" data-bs-placement="right"> 
							...
							<span class="menu--label">Mon équipe</span>
						</a>
					</li>
				</ul>
			</div>
							...
							<div class="main-card mt-5">
								...
								<div class="about-details">
									<div class="about-step text-center">
										...
										<div class="user-dts">
											<h4 class="user-name">Basile SOWADAN<span class="verify-badge"><i class="fa-solid fa-circle-check"></i></span></h4>
											<span class="user-email">basile14sowadan@gmail.com</span>
										</div>
									</div>
									<div class="about-step">
										<h5>Parlez-nous de vous et faites savoir aux gens qui vous êtes</h5>
										<p class="mb-0">Développeur web et promoteur de Event-CERIL.</p>
									</div>
									<div class="about-step">
										<h5>Trouvez-moi sur</h5>
									...
									<div class="about-step">
										<h5>Addresse</h5>
										<p class="mb-0">Nukafu, Lomé, Togo</p>
									</div>
									<div class="about-step">
