		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="couponModalLabel">Créez votre coupon</h5>
							...
							<div class="col-lg-6 col-md-12">
								<div class="form-group main-form mt-4">
									...
									<select class="selectpicker">
										<option value="percent" selected>Pour cent(%)</option>
										<option value="fixed">Prix fixe(F CFA)</option>																									
									</select>
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="form-group mt-4">
									<label class="form-label">Fin de la réduction*</label>
				...
				<div class="modal-footer">
					...
					<button type="button" class="main-btn min-width btn-hover h_40">Créer</button>
				</div>
			</div>
		</div>
	</div>
							...
							<div class="dashboard-wrap-content p-4">
								...
								<div class="d-md-flex flex-wrap align-items-center">
									...
									<div class="rs ms-auto mt_r4">
										<button class="main-btn btn-hover h_40 w-100" data-bs-toggle="modal" data-bs-target="#couponModal">Créer coupon</button>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="contact-list coupon-active">
									<div class="top d-flex flex-wrap justify-content-between align-items-center p-4 border_bottom">
										<div class="icon-box">
											...
											<p class="text-gray-50 m-0"><span class="visitor-date-time">Jeudi, 27 Septembre 2023, 07h 30 </span> - <span class="visitor-date-time">Vendredi 26 Avril, 2023 07h 30 </span></p>
										</div>
