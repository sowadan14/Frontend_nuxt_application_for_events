		...
		<div class="app-form">
			...
			<div class="app-form-content">
						...
						<div class="col-xl-5 col-lg-6 col-md-7">
							<div class="registration">
									...
									<div class="row mt-3">
										<div class="col-lg-6 col-md-12">
											<div class="form-group mt-4">
												...
												<input class="form-control h_50" type="text" placeholder="Votre prénom" value="">																								
											</div>
										</div>
										<div class="col-lg-6 col-md-12">
											<div class="form-group mt-4">
												<label class="form-label">Nom*</label>
												<input class="form-control h_50" type="text" placeholder="Votre nom" value="">																								
											</div>
										</div>
										<div class="col-lg-12 col-md-12">
											<div class="form-group mt-4">
												<label class="form-label">Votre Email*</label>
												<input class="form-control h_50" type="email" placeholder="Votre adresse mail" value="">																								
											</div>
										</div>
										<div class="col-lg-12 col-md-12">	
											<div class="form-group mt-4">
												...
												<div class="loc-group position-relative">
													<input class="form-control h_50" type="password" placeholder="Votre mot de passe">
								...
								<div class="agree-text">
									En cliquant sur "S'inscrire", vous acceptez notre plateforme <a href="term_and_conditions.html">Termes & conditions</a>.
								</div>								
								<div class="divider">
									<span>or</span>
								</div>
								...
								<div class="new-sign-link">
									Vous avez déjà un compte?<a class="signup-link" href="sign_in.html">S'inscrire</a>
								</div>
							</div>							
						</div>
					</div>
				...
				<div class="copyright-footer">
					© 2023, Event-CERIL. Tous droits réservés. Propulsé par CERIL
				</div>
			</div>			
		</div>
	</div>
