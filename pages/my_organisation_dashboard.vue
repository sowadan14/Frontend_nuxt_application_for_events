		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="addorganisationLabel">Détails de l'organisation</h5>
				...
				<div class="modal-body">
					<div class="model-content main-form">
						<div class="row">
							...
							<div class="col-lg-12 col-md-12">
								<div class="form-group mt-4">
									<label class="form-label">Lien de profil*</label>
									<input class="form-control h_40" type="text" placeholder="" value="https://www.event-ceril.com/b/organiser/" disabled>																								
								</div>
							</div>
							<div class="col-lg-12 col-md-12">
								<div class="form-group mt-4">
									<label class="form-label">À propos
										*</label>
									<textarea class="form-textarea"  placeholder="">À propos
									</textarea>																							
								</div>
							</div>
						...
						<div class="main-card add-organisation-card p-4 mt-5">
							<div class="ocard-left">
								...
								<div class="ocard-name">
									<h4>Basile SOWADAN</h4>
									<span>Mon Organisation</span>
								</div>
							</div>
							<div class="ocard-right">
								<button class="pe-4 ps-4 co-main-btn min-width" data-bs-toggle="modal" data-bs-target="#addorganisationModal"><i class="fa-solid fa-plus"></i>Ajouter Organisation</button>
							</div>
						</div>
									...
									<div class="rs">
										<div class="dropdown dropdown-text event-list-dropdown">
											<button class="dropdown-toggle event-list-dropdown" type="button" data-bs-toggle="dropdown" aria-expanded="false">
												<span>Événements sélectionnés(1)</span>
											</button>
									...
									<div class="row">
										<div class="col-xl-3 col-lg-6 col-md-6">
											<div class="dashboard-report-card purple">
												<div class="card-content">
													<div class="card-content">
														<span class="card-title fs-6">Revenus (F CFA)</span>
														<span class="card-sub-title fs-3">1 200 000 F CFA</span>
														<div class="d-flex align-items-center">
															<span><i class="fa-solid fa-arrow-trend-up"></i></span>
															<span class="text-Light font-12 ms-2 me-2">0.00%</span>
															<span class="font-12 color-body text-nowrap">De la période précédente</span>
														</div>
													</div>
										...
										<div class="col-xl-3 col-lg-6 col-md-6">
											<div class="dashboard-report-card red">
												<div class="card-content">
													<div class="card-content">
														<span class="card-title fs-6">Réservations</span>
										...
										<div class="col-xl-3 col-lg-6 col-md-6">
											<div class="dashboard-report-card success">
												<div class="card-content">
													<div class="card-content">
														<span class="card-title fs-6">La vente de tickets</span>
									...
									<div class="select-graphic-category">
										<div class="form-group main-form mb-2">
											<select class="selectpicker" data-width="150px">
												...
												<option value="orders">Ordre</option>
												<option value="pageviews">Pages vues</option>
												<option value="ticketsales">La vente de tickets</option>
											</select>
										</div>
										<small class="mt-4">Voir la représentation graphique ci-dessous</small>
									</div>
								</div>
								<div class="rs">
									<div class="btn-group" role="group" aria-label="Basic radio toggle button group">
										<input type="radio" class="btn-check" name="btnradio" id="btnradio1">
										<label class="btn btn-outline-primary" for="btnradio1">Mensuelle</label>
										<input type="radio" class="btn-check" name="btnradio" id="btnradio2" checked>
										<label class="btn btn-outline-primary" for="btnradio2">Hebdomadaire</label>
										<input type="radio" class="btn-check" name="btnradio" id="btnradio3">
										<label class="btn btn-outline-primary" for="btnradio3">Tous les jours</label>
									</div>
								</div>
							</div>
...
<script>
  ...
  import organisationDashboardHeader from '@/components/Global/organisationDashboardHeader.vue'
  export default {
        components: {
            organisationDashboardHeader
        }
